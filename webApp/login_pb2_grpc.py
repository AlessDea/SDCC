...
class LoginStub(object):
    ...
    def __init__(self, channel):
        ...
        self.doLogin = channel.unary_unary(
                '/login.Login/doLogin',
                request_serializer=login__pb2.PwRequest.SerializeToString,
                response_deserializer=login__pb2.PwReply.FromString,
                )
...
def add_LoginServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'doLogin': grpc.unary_unary_rpc_method_handler(
                    servicer.doLogin,
                    request_deserializer=login__pb2.PwRequest.FromString,
                    response_serializer=login__pb2.PwReply.SerializeToString,
            ),
    }
...
class Login(object):
    ...
    def doLogin(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/login.Login/doLogin',
            login__pb2.PwRequest.SerializeToString,
            login__pb2.PwReply.FromString,
